...
public class MCstProductionType {
  ...
  public MCstProductionTypeDeclaration newCstProductionTypeDeclaration(String pName) {
    MCstProductionTypeDeclaration lCstProductionTypeDeclaration = new MCstProductionTypeDeclaration(pName);
