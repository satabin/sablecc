...
public class MAlternative {
  ...
  public MAltNormalApply newAltNormalApply() {
    MAltNormalApply lAltNormalApply = new MAltNormalApply(mAlternative);
  ...
  public MNormalContructorInitialization newNormalContructorInitialization(String pElementName) {
    MNormalContructorInitialization lNormalContructorInitialization = new MNormalContructorInitialization(pElementName);
    this.eNormalContructorInitialization.add(lNormalContructorInitialization);
  ...
  public MListElementAccessor newListElementAccessor(String pListType, String pElementName) {
    MListElementAccessor lListElementAccessor = new MListElementAccessor(pListType, pElementName);
    this.eListElementAccessor.add(lListElementAccessor);
    return lListElementAccessor;
  }

  public MSeparatedListElementAccessor newSeparatedListElementAccessor(String pLeftListType, String pRightListType, String pElementName) {
    MSeparatedListElementAccessor lSeparatedListElementAccessor = new MSeparatedListElementAccessor(pLeftListType, pRightListType, pElementName);
    this.eSeparatedListElementAccessor.add(lSeparatedListElementAccessor);
    return lSeparatedListElementAccessor;
  }

  public MAlternatedListElementAccessor newAlternatedListElementAccessor(String pLeftListType, String pRightListType, String pElementName) {
    MAlternatedListElementAccessor lAlternatedListElementAccessor = new MAlternatedListElementAccessor(pLeftListType, pRightListType, pElementName);
  ...
  public MNormalElementDeclaration newNormalElementDeclaration(String pElementType, String pElementName) {
    MNormalElementDeclaration lNormalElementDeclaration = new MNormalElementDeclaration(pElementType, pElementName);
    this.eNormalElementDeclaration_ListElementDeclaration_AlternatedListElementDeclaration_SeparatedListElementDeclaration_EndElementDeclaration.add(lNormalElementDeclaration);
    return lNormalElementDeclaration;
  }

  public MListElementDeclaration newListElementDeclaration(String pListType, String pElementName) {
    MListElementDeclaration lListElementDeclaration = new MListElementDeclaration(pListType, pElementName);
    this.eNormalElementDeclaration_ListElementDeclaration_AlternatedListElementDeclaration_SeparatedListElementDeclaration_EndElementDeclaration.add(lListElementDeclaration);
    return lListElementDeclaration;
  }

  public MAlternatedListElementDeclaration newAlternatedListElementDeclaration(String pLeftListType, String pRightListType, String pElementName) {
    MAlternatedListElementDeclaration lAlternatedListElementDeclaration = new MAlternatedListElementDeclaration(pLeftListType, pRightListType, pElementName);
    this.eNormalElementDeclaration_ListElementDeclaration_AlternatedListElementDeclaration_SeparatedListElementDeclaration_EndElementDeclaration.add(lAlternatedListElementDeclaration);
    return lAlternatedListElementDeclaration;
  }

  public MSeparatedListElementDeclaration newSeparatedListElementDeclaration(String pLeftListType, String pRightListType, String pElementName) {
    MSeparatedListElementDeclaration lSeparatedListElementDeclaration = new MSeparatedListElementDeclaration(pLeftListType, pRightListType, pElementName);
    this.eNormalElementDeclaration_ListElementDeclaration_AlternatedListElementDeclaration_SeparatedListElementDeclaration_EndElementDeclaration.add(lSeparatedListElementDeclaration);
  ...
  public MEndElementDeclaration newEndElementDeclaration() {
    ...
    this.eNormalElementDeclaration_ListElementDeclaration_AlternatedListElementDeclaration_SeparatedListElementDeclaration_EndElementDeclaration.add(lEndElementDeclaration);
    return lEndElementDeclaration;
  }

  public MNormalChildApply newNormalChildApply(String pElementName) {
    MNormalChildApply lNormalChildApply = new MNormalChildApply(pElementName);
  ...
  public MNormalConstructorParameter newNormalConstructorParameter(String pElementType, String pElementName) {
    ...
    this.eNormalConstructorParameter_ListConstructorParameter_AlternatedListConstructorParameter_SeparatedListConstructorParameter_EndConstructorParameter.add(lNormalConstructorParameter);
    return lNormalConstructorParameter;
  }

  public MListConstructorParameter newListConstructorParameter(String pListType, String pElementName) {
    MListConstructorParameter lListConstructorParameter = new MListConstructorParameter(pListType, pElementName);
    this.eNormalConstructorParameter_ListConstructorParameter_AlternatedListConstructorParameter_SeparatedListConstructorParameter_EndConstructorParameter.add(lListConstructorParameter);
    return lListConstructorParameter;
  }

  public MAlternatedListConstructorParameter newAlternatedListConstructorParameter(String pLeftListType, String pRightListType, String pElementName) {
    MAlternatedListConstructorParameter lAlternatedListConstructorParameter = new MAlternatedListConstructorParameter(pLeftListType, pRightListType, pElementName);
    this.eNormalConstructorParameter_ListConstructorParameter_AlternatedListConstructorParameter_SeparatedListConstructorParameter_EndConstructorParameter.add(lAlternatedListConstructorParameter);
    return lAlternatedListConstructorParameter;
  }

  public MSeparatedListConstructorParameter newSeparatedListConstructorParameter(String pLeftListType, String pRightListType, String pElementName) {
    MSeparatedListConstructorParameter lSeparatedListConstructorParameter = new MSeparatedListConstructorParameter(pLeftListType, pRightListType, pElementName);
    this.eNormalConstructorParameter_ListConstructorParameter_AlternatedListConstructorParameter_SeparatedListConstructorParameter_EndConstructorParameter.add(lSeparatedListConstructorParameter);
  ...
  public MEndConstructorParameter newEndConstructorParameter() {
    ...
    this.eNormalConstructorParameter_ListConstructorParameter_AlternatedListConstructorParameter_SeparatedListConstructorParameter_EndConstructorParameter.add(lEndConstructorParameter);
  ...
  public MNormalElementAccessor newNormalElementAccessor(String pElementType, String pElementName) {
    MNormalElementAccessor lNormalElementAccessor = new MNormalElementAccessor(pElementType, pElementName);
  ...
  public String toString() {
    ...
    for(Object oNormalElementDeclaration_ListElementDeclaration_AlternatedListElementDeclaration_SeparatedListElementDeclaration_EndElementDeclaration : this.eNormalElementDeclaration_ListElementDeclaration_AlternatedListElementDeclaration_SeparatedListElementDeclaration_EndElementDeclaration) {
      sb.append(oNormalElementDeclaration_ListElementDeclaration_AlternatedListElementDeclaration_SeparatedListElementDeclaration_EndElementDeclaration.toString());
    }
    sb.append(System.getProperty("line.separator"));
    sb.append("  @Override");
    sb.append(System.getProperty("line.separator"));
    ...
    if(this.eNormalConstructorParameter_ListConstructorParameter_AlternatedListConstructorParameter_SeparatedListConstructorParameter_EndConstructorParameter.size() > 0) {
      sb.append(", ");
    }
    {
      boolean first = true;
      for(Object oNormalConstructorParameter_ListConstructorParameter_AlternatedListConstructorParameter_SeparatedListConstructorParameter_EndConstructorParameter : this.eNormalConstructorParameter_ListConstructorParameter_AlternatedListConstructorParameter_SeparatedListConstructorParameter_EndConstructorParameter) {
        ...
        sb.append(oNormalConstructorParameter_ListConstructorParameter_AlternatedListConstructorParameter_SeparatedListConstructorParameter_EndConstructorParameter.toString());
      }
    }
    sb.append(") {");
    sb.append(System.getProperty("line.separator"));
