...
public class MReduce {
  ...
  MReduce(String pReducedProduction) {
    if(pReducedProduction == null) throw new NullPointerException();
    this.pReducedProduction = pReducedProduction;
  }

  public MReduceDecision newReduceDecision() {
    MReduceDecision lReduceDecision = new MReduceDecision(mReduce);
  ...
  public MAcceptDecision newAcceptDecision(String pElementName) {
  ...
  public MReduceNormalPop newReduceNormalPop(String pElementName) {
