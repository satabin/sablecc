...
public class MReduceDecision {
  ...
  MReduceDecision(MReduce mReduce) {
    if(mReduce == null) throw new NullPointerException();
    this.mReduce = mReduce;
  }

  public MAddPopToForest newAddPopToForest(String pElementName, String pIndex) {
    MAddPopToForest lAddPopToForest = new MAddPopToForest(pElementName, pIndex);
  ...
  public MAddLToForest newAddLToForest(String pElementName) {
  ...
  public MAddNToForest newAddNToForest(String pElementName) {
