...
public class MAddPopReverseAlternatedList {
  ...
  MAddPopReverseAlternatedList(String pListName, String pElementName, String pLeftType, String pRightType, String pIndex) {
    ...
    if(pLeftType == null) throw new NullPointerException();
    this.pLeftType = pLeftType;
    if(pRightType == null) throw new NullPointerException();
