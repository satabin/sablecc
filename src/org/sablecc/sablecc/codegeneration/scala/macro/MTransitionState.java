...
public class MTransitionState {
  ...
  private final MTransitionState mTransitionState = this;
  private final List<Object> eDefaultPackage_SpecifiedPackage = new LinkedList<Object>();

  public MTransitionState(String pPkg) {
  ...
  private String rPkg() {
    return this.mTransitionState.pPkg();
  }
  ...
  public String toString() {
    ...
    sb.append("  protected[");
    sb.append(rPkg());
    sb.append("] def marker(lexer: Lexer): Unit");
    sb.append(System.getProperty("line.separator"));
    sb.append("  protected[");
    sb.append(rPkg());
    sb.append("] def target(symbol: Symbol): State");
    sb.append(System.getProperty("line.separator"));
    sb.append(System.getProperty("line.separator"));
    sb.append("  protected[");
    sb.append(rPkg());
    sb.append("] def stateType = StateType.TRANSITION");
    sb.append(System.getProperty("line.separator"));
    sb.append("}");
    sb.append(System.getProperty("line.separator"));
    return sb.toString();
