...
public class MReduce {
  ...
  MReduce(String pAlternative) {
    if(pAlternative == null) throw new NullPointerException();
    this.pAlternative = pAlternative;
  }

  public MNormalParameter newNormalParameter(String pElementName) {
  ...
  public MReduceNormalPop newReduceNormalPop(String pElementType, String pElementName) {
    MReduceNormalPop lReduceNormalPop = new MReduceNormalPop(pElementType, pElementName);
  ...
  public String toString() {
    ...
    sb.append("      val stack = parser.stack");
