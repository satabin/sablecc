...
public class MBadAlternativeTransformationReference {
  ...
  public MBadAlternativeTransformationReference(String pReferenceText, String pProdName, String pLine, String pChar) {
    if(pReferenceText == null) throw new NullPointerException();
