...
public class MAmbiguousAlternativeTransformation {
  ...
  public MAmbiguousAlternativeTransformation(String pElemName, String pParserAltName, String pParserProdName, String pTreeLine, String pTreeChar, String pParserLine, String pFirstParserChar, String pSecondParserChar) {
    ...
    if(pTreeLine == null) throw new NullPointerException();
    this.pTreeLine = pTreeLine;
    if(pTreeChar == null) throw new NullPointerException();
    this.pTreeChar = pTreeChar;
    if(pParserLine == null) throw new NullPointerException();
    this.pParserLine = pParserLine;
    if(pFirstParserChar == null) throw new NullPointerException();
    this.pFirstParserChar = pFirstParserChar;
    if(pSecondParserChar == null) throw new NullPointerException();
