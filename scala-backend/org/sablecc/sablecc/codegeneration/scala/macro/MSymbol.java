...
public class MSymbol {
  ...
  public MSymbolDeclaration newSymbolDeclaration(String pName) {
  ...
  public MSingleChar newSingleChar(String pBound, String pName) {
    MSingleChar lSingleChar = new MSingleChar(pBound, pName);
    this.eSingleChar.add(lSingleChar);
    return lSingleChar;
  }

  public MOpenInterval newOpenInterval(String pName) {
    MOpenInterval lOpenInterval = new MOpenInterval(pName);
    this.eOpenInterval.add(lOpenInterval);
    return lOpenInterval;
  }

  public MOpenLeftInterval newOpenLeftInterval(String pUpperBound, String pName) {
    MOpenLeftInterval lOpenLeftInterval = new MOpenLeftInterval(pUpperBound, pName);
    this.eOpenLeftInterval.add(lOpenLeftInterval);
    return lOpenLeftInterval;
  }

  public MOpenRightInterval newOpenRightInterval(String pLowerBound, String pName) {
    MOpenRightInterval lOpenRightInterval = new MOpenRightInterval(pLowerBound, pName);
    this.eOpenRightInterval.add(lOpenRightInterval);
    return lOpenRightInterval;
  }

  public MInterval newInterval(String pLowerBound, String pUpperBound, String pName) {
  ...
  public String toString() {
    ...
    sb.append(System.getProperty("line.separator"));
    sb.append("object Symbol extends Enumeration {");
    sb.append(System.getProperty("line.separator"));
    sb.append("  type Symbol = Value");
    sb.append(System.getProperty("line.separator"));
    sb.append("  val");
    sb.append(System.getProperty("line.separator"));
    ...
    sb.append("  Symbol_end = Value");
    sb.append(System.getProperty("line.separator"));
    sb.append(System.getProperty("line.separator"));
    sb.append("  def symbol(c: Char): Symbol = c match {");
    sb.append(System.getProperty("line.separator"));
